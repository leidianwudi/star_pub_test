...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '1', description: '用户ID:1' }),
    __metadata("design:type", String)
], AdminResponseDto.prototype, "id", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'user1', description: '用户名:username' }),
    __metadata("design:type", String)
], AdminResponseDto.prototype, "username", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Admin', description: '角色:Admin' }),
    __metadata("design:type", String)
