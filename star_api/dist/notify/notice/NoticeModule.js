...
exports.NoticeModule = NoticeModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([En_Notice_1.En_Notice])],
        controllers: [NoticeController_1.NoticeController],
        providers: [NoticeService_1.NoticeService],
        exports: [NoticeService_1.NoticeService],
    })
], NoticeModule);
