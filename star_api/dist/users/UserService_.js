...
exports.UserService_ = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const common_2 = require("@nestjs/common");
const En_User_1 = require("./entities/En_User");
const RepUser_1 = require("./model/RepUser");
let UserService_ = class UserService_ {
    constructor(En_UserRep) {
        this.En_UserRep = En_UserRep;
        this.rep = new RepUser_1.RepUser(En_UserRep);
    }
...
exports.UserService_ = UserService_;
exports.UserService_ = UserService_ = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(En_User_1.En_User)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], UserService_);
//# sourceMappingURL=UserService_.js.map