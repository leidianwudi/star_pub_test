...
exports.RepRankDayCoinLog_ = void 0;
const RepositorySuper_1 = require("../../../../common/RepositorySuper");
class RepRankDayCoinLog_ extends RepositorySuper_1.RepositorySuper {
    constructor(db) {
        super(db);
        this.db = db;
    }
...
exports.RepRankDayCoinLog_ = RepRankDayCoinLog_;
//# sourceMappingURL=RepRankDayCoinLog_.js.map