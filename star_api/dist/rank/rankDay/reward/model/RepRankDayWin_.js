...
exports.RepRankDayWin_ = void 0;
const RepositorySuper_1 = require("../../../../common/RepositorySuper");
class RepRankDayWin_ extends RepositorySuper_1.RepositorySuper {
    constructor(db) {
        super(db);
        this.db = db;
    }
...
exports.RepRankDayWin_ = RepRankDayWin_;
//# sourceMappingURL=RepRankDayWin_.js.map