...
exports.RepRankWeekCoinLog_ = void 0;
const RepositorySuper_1 = require("../../../../common/RepositorySuper");
class RepRankWeekCoinLog_ extends RepositorySuper_1.RepositorySuper {
    constructor(db) {
        super(db);
        this.db = db;
    }
...
exports.RepRankWeekCoinLog_ = RepRankWeekCoinLog_;
//# sourceMappingURL=RepRankWeekCoinLog_.js.map