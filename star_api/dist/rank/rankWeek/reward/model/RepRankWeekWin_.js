...
exports.RepRankWeekWin_ = void 0;
const RepositorySuper_1 = require("../../../../common/RepositorySuper");
class RepRankWeekWin_ extends RepositorySuper_1.RepositorySuper {
    constructor(db) {
        super(db);
        this.db = db;
    }
...
exports.RepRankWeekWin_ = RepRankWeekWin_;
//# sourceMappingURL=RepRankWeekWin_.js.map