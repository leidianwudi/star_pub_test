...
exports.RepRankWeekWinLog_ = void 0;
const RepositorySuper_1 = require("../../../../common/RepositorySuper");
class RepRankWeekWinLog_ extends RepositorySuper_1.RepositorySuper {
    constructor(db) {
        super(db);
        this.db = db;
    }
...
exports.RepRankWeekWinLog_ = RepRankWeekWinLog_;
//# sourceMappingURL=RepRankWeekWinLog_.js.map