...
exports.GameBaseService_ = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const common_2 = require("@nestjs/common");
const En_GameBase_1 = require("./entities/En_GameBase");
const RepGameBase_1 = require("./model/RepGameBase");
let GameBaseService_ = class GameBaseService_ {
    constructor(En_GameBaseRep) {
        this.En_GameBaseRep = En_GameBaseRep;
        this.rep = new RepGameBase_1.RepGameBase(En_GameBaseRep);
    }
...
exports.GameBaseService_ = GameBaseService_;
exports.GameBaseService_ = GameBaseService_ = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(En_GameBase_1.En_GameBase)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], GameBaseService_);
//# sourceMappingURL=GameBaseService_.js.map