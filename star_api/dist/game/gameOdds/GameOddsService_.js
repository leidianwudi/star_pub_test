...
exports.GameOddsService_ = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const common_2 = require("@nestjs/common");
const En_GameOdds_1 = require("./entities/En_GameOdds");
const RepGameOdds_1 = require("./model/RepGameOdds");
let GameOddsService_ = class GameOddsService_ {
    constructor(En_GameOddsRep) {
        this.En_GameOddsRep = En_GameOddsRep;
        this.rep = new RepGameOdds_1.RepGameOdds(En_GameOddsRep);
    }
...
exports.GameOddsService_ = GameOddsService_;
exports.GameOddsService_ = GameOddsService_ = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(En_GameOdds_1.En_GameOdds)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], GameOddsService_);
//# sourceMappingURL=GameOddsService_.js.map