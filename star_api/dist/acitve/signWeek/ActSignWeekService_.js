...
exports.ActSignWeekService_ = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const common_2 = require("@nestjs/common");
const En_ActSignWeek_1 = require("./entities/En_ActSignWeek");
const RepActSignWeek_1 = require("./model/RepActSignWeek");
let ActSignWeekService_ = class ActSignWeekService_ {
    constructor(En_ActSignWeekRep) {
        this.En_ActSignWeekRep = En_ActSignWeekRep;
        this.rep = new RepActSignWeek_1.RepActSignWeek(En_ActSignWeekRep);
    }
...
exports.ActSignWeekService_ = ActSignWeekService_;
exports.ActSignWeekService_ = ActSignWeekService_ = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(En_ActSignWeek_1.En_ActSignWeek)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], ActSignWeekService_);
//# sourceMappingURL=ActSignWeekService_.js.map