...
exports.ReportDayPersonService_ = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const common_2 = require("@nestjs/common");
const En_ReportDayPerson_1 = require("./entities/En_ReportDayPerson");
const RepReportDayPerson_1 = require("./model/RepReportDayPerson");
let ReportDayPersonService_ = class ReportDayPersonService_ {
    constructor(En_ReportDayPersonRep) {
        this.En_ReportDayPersonRep = En_ReportDayPersonRep;
        this.rep = new RepReportDayPerson_1.RepReportDayPerson(En_ReportDayPersonRep);
    }
...
exports.ReportDayPersonService_ = ReportDayPersonService_;
exports.ReportDayPersonService_ = ReportDayPersonService_ = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(En_ReportDayPerson_1.En_ReportDayPerson)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], ReportDayPersonService_);
//# sourceMappingURL=ReportDayPersonService_.js.map