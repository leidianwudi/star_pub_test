...
exports.ReportGameLogService_ = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const common_2 = require("@nestjs/common");
const En_ReportGameLog_1 = require("./entities/En_ReportGameLog");
const RepReportGameLog_1 = require("./model/RepReportGameLog");
let ReportGameLogService_ = class ReportGameLogService_ {
    constructor(En_ReportGameLogRep) {
        this.En_ReportGameLogRep = En_ReportGameLogRep;
        this.rep = new RepReportGameLog_1.RepReportGameLog(En_ReportGameLogRep);
    }
...
exports.ReportGameLogService_ = ReportGameLogService_;
exports.ReportGameLogService_ = ReportGameLogService_ = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(En_ReportGameLog_1.En_ReportGameLog)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], ReportGameLogService_);
//# sourceMappingURL=ReportGameLogService_.js.map