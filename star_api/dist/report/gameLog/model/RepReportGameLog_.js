...
exports.RepReportGameLog_ = void 0;
const RepositorySuper_1 = require("../../../common/RepositorySuper");
class RepReportGameLog_ extends RepositorySuper_1.RepositorySuper {
    constructor(db) {
        super(db);
        this.db = db;
    }
...
exports.RepReportGameLog_ = RepReportGameLog_;
//# sourceMappingURL=RepReportGameLog_.js.map