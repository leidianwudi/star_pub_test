...
exports.ReportDayGameUtcService_ = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const common_2 = require("@nestjs/common");
const En_ReportDayGameUtc_1 = require("./entities/En_ReportDayGameUtc");
const RepReportDayGameUtc_1 = require("./model/RepReportDayGameUtc");
let ReportDayGameUtcService_ = class ReportDayGameUtcService_ {
    constructor(En_ReportDayGameUtcRep) {
        this.En_ReportDayGameUtcRep = En_ReportDayGameUtcRep;
        this.rep = new RepReportDayGameUtc_1.RepReportDayGameUtc(En_ReportDayGameUtcRep);
    }
...
exports.ReportDayGameUtcService_ = ReportDayGameUtcService_;
exports.ReportDayGameUtcService_ = ReportDayGameUtcService_ = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(En_ReportDayGameUtc_1.En_ReportDayGameUtc)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], ReportDayGameUtcService_);
//# sourceMappingURL=ReportDayGameUtcService_.js.map