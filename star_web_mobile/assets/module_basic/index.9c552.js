    ...
    execute: function () {
      ...
      var Layout_UIHistoryDetailsItem = exports('Layout_UIHistoryDetailsItem', (_dec = ccclass('Layout_UIHistoryDetailsItem'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        _proto.init = function init(data) {
          this.txt_time.string = data.date;
          this.txt_touru.string = data.touru;
          this.txt_win.string = data.win;
          this.txt_jiesuan.string = data.jiesuan;
          this.txt_game.string = data.game;
          this.txt_order.string = data.order;
        }
        /**设置背景是否可见 */;
  ...
  return {
    ...
    execute: function () {
      ...
      var Layout_UIHistoryItem = exports('Layout_UIHistoryItem', (_dec = ccclass('Layout_UIHistoryItem'), _dec2 = property(Button), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        _proto.init = function init(data) {
          this._data = data;
          this.txt_date.string = data.date;
...
System.register("chunks:///_virtual/LobbyMgr.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SceneDef.ts', './NetGameServer.ts', './UserMgr.ts', './NetUtil.ts', './SubGameMgr.ts', './LanguageData.ts', './Constants.ts', './RoomMgr.ts'], function (exports) {
  var _createClass, _asyncToGenerator, _regeneratorRuntime, cclegacy, director, SceneDef, lobbyNet, loginNet, UserMgr, NetUtil, SubGameMgr, LanguageData, RoomMgr;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
      _asyncToGenerator = module.asyncToGenerator;
    ...
    execute: function () {
      ...
      var MenuBar = exports('MenuBar', (_dec = ccclass('MenuBar'), _dec2 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        _proto.onBtnCoinClicked = function onBtnCoinClicked() {
          tgx.UIMgr.inst.showUI(UIShop);
          var shop = UIShop.getInstance();
          shop.defaultTab = 'chongzhi';
        };
...
System.register("chunks:///_virtual/NetGameServer.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './WebsocketClient.ts', './UserLocalCache.ts', './NetUtil.ts', './Constants.ts'], function (exports) {
  var _inheritsLoose, _createClass, _asyncToGenerator, _regeneratorRuntime, cclegacy, WebsocketClient, UserLocalCache, NetUtil;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
      _createClass = module.createClass;
    ...
    execute: function () {
      ...
      var NetLobbyServer = exports('NetLobbyServer', /*#__PURE__*/function (_WebsocketClient) {
        ...
        function NetLobbyServer() {
          var _this;
          _this = _WebsocketClient.call(this) || this;
      ...
      var NetGameServer = exports('NetGameServer', /*#__PURE__*/function (_WebsocketClient2) {
        ...
        function NetGameServer() {
          ...
          _this2 = _WebsocketClient2.call.apply(_WebsocketClient2, [this].concat(args)) || this;
          _this2.authParams = void 0;
          return _this2;
        }
        var _proto2 = NetGameServer.prototype;
        _proto2.connectToRoomServer = /*#__PURE__*/function () {
          var _connectToRoomServer = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(params) {
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
          ...
          function connectToRoomServer(_x4) {
            return _connectToRoomServer.apply(this, arguments);
          }
          return connectToRoomServer;
        }();
        _proto2.joinRoomServer = /*#__PURE__*/function () {
          var _joinRoomServer = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(uid) {
            var retJoin;
            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
                ...
                case 2:
                  retJoin = _context3.sent;
                  return _context3.abrupt("return", retJoin);
                case 4:
                case "end":
                  return _context3.stop();
              }
          ...
          function joinRoomServer(_x5) {
            return _joinRoomServer.apply(this, arguments);
          }
          return joinRoomServer;
        }();
        _proto2.playSlots = /*#__PURE__*/function () {
          var _playSlots = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(gamekey, bet) {
            var retSpin;
            return _regeneratorRuntime().wrap(function _callee4$(_context4) {
              while (1) switch (_context4.prev = _context4.next) {
                case 0:
                ...
                case 2:
                  ...
                  return _context4.abrupt("return", retSpin);
                case 4:
                case "end":
                  return _context4.stop();
              }
          ...
          function playSlots(_x6, _x7) {
            return _playSlots.apply(this, arguments);
          }
          return playSlots;
        }();
        _proto2.PlayMatch3 = /*#__PURE__*/function () {
          var _PlayMatch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(gamekey, bet) {
            var retSpin;
            return _regeneratorRuntime().wrap(function _callee5$(_context5) {
              while (1) switch (_context5.prev = _context5.next) {
                case 0:
                ...
                case 2:
                  retSpin = _context5.sent;
                  return _context5.abrupt("return", retSpin);
                case 4:
                case "end":
                  return _context5.stop();
              }
      ...
      var httpNet = exports('httpNet', new HttpLobbyServer());
      cclegacy._RF.pop();
    }
  };
});
    ...
    execute: function () {
      ...
      var NetworkReconnector = exports('NetworkReconnector', (_dec = ccclass('NetworkReconnector'), _dec(_class = /*#__PURE__*/function (_Component) {
        ...
        _proto.start = function start() {
          ...
          gameNet.on(WebsocketClient.EVENT_DISCONNECTED, this.onDisconnected, this);
          gameNet.on(WebsocketClient.EVENT_CONNECTED, this.onconnected, this);
          if (lobbyNet.type != 'http') {
            var net = lobbyNet;
            net.on(WebsocketClient.EVENT_DISCONNECTED, this.onDisconnected, this);
          }
        };
        _proto.onDestroy = function onDestroy() {
          gameNet.off(WebsocketClient.EVENT_DISCONNECTED, this.onDisconnected, this);
          gameNet.off(WebsocketClient.EVENT_CONNECTED, this.onconnected, this);
          if (lobbyNet.type != 'http') {
            var net = lobbyNet;
            net.off(WebsocketClient.EVENT_DISCONNECTED, this.onDisconnected, this);
          }
        };
...
System.register("chunks:///_virtual/UIHistory.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './GameUILayers.ts', './Layout_UIHistory.ts', './Layout_UIHistoryItem.ts', './Layout_UIHistoryOptionItem.ts', './SubGameDef.ts', './ModuleDef.ts', './LanguageData.ts'], function (exports) {
  var _inheritsLoose, _asyncToGenerator, _regeneratorRuntime, cclegacy, Sprite, instantiate, Vec3, Button, NodeEventType, GameUILayers, Layout_UIHistory, Layout_UIHistoryItem, Layout_UIHistoryOptionItem, subGameConf, SubGameType, ModuleDef, LanguageData;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
      _asyncToGenerator = module.asyncToGenerator;
    ...
    execute: function () {
      ...
      var UIHistory = exports('UIHistory', (_dec = tgx_class(ModuleDef.BASIC), _dec(_class = /*#__PURE__*/function (_tgx$UIController) {
        ...
        _proto.onBindData = function onBindData(data) {
          ...
          layout.txt_cishu.string = data.cishu;
          layout.txt_touru.string = data.touru;
          layout.txt_win.string = data.win;
          layout.txt_jiesuan.string = data.jiesuan;
          this._curPage = 1;
          this._totalPage = 10;
        ...
        _proto.onUpdateHistory = function onUpdateHistory() {
          ...
          for (var i = 0; i < this._data.records.length; i++) {
            ...
            item.setPosition(new Vec3(0));
            item.active = true;
            item.getComponent(Layout_UIHistoryItem).init(this._data.records[i]);
            if (i % 2 == 0) {
        ...
        _proto.onInitOption = function onInitOption() {
          this.onClickOptionItem(this._classList[0], 1);
          this.onClickOptionItem(this._gameList[0], 2);
          this.onClickOptionItem(this._dateList[0], 3);
        };
        _proto.onClickOptionItem = function onClickOptionItem(data, type) {
          var layout = this._layout;
          switch (type) {
            case 1:
...
System.register("chunks:///_virtual/UIHistoryDetails.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './GameUILayers.ts', './Layout_UIHistoryItem.ts', './Layout_UIHistoryDetails.ts', './Layout_UIHistoryDetailsItem.ts'], function (exports) {
  var _inheritsLoose, _asyncToGenerator, _regeneratorRuntime, cclegacy, Sprite, instantiate, Vec3, Button, GameUILayers, Layout_UIHistoryItem, Layout_UIHistoryDetails, Layout_UIHistoryDetailsItem;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
      _asyncToGenerator = module.asyncToGenerator;
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  // 初始化界面显示状态
                  layout.emptyTips.active = true; // 显示空提示
